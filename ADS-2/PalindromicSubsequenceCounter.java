...
public class PalindromicSubsequenceCounter {
    ...
    public static void main(String[] args) {
        ...
        PalindromicSubsequenceCounter counter = new PalindromicSubsequenceCounter();
        int result = counter.countPalindromicSubsequence(s);
